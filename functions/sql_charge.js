...
//Fonction principale
//=============================================================
// module.exports = async function dl_map_SQL(server, url) {
module.exports = async function dl_map_SQL() {
    let url = 'http://localhost:3000';
    ...
    sql_cleaned.forEach(town_sql => {
        ...
        if (town_sql.length != 12) {
            ...
            save_town(olddata_village, array_village, town_sql, test_date, server, array_new_town);
...
//GET 
async function getData_new_SQL(server, url) {
    let url_SQL;
...
//////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////
function save_town(olddata_village, array_village, element, test_date, server, array_new_town) {
    let element_vivi;
